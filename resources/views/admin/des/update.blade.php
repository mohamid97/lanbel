                        ...
                        <div class="border p-3">
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[{{$lang->code}}]" class="form-control" id="name" placeholder="Enter Name" value="{{ $des->translate($lang->code)->name }}">
                        ...
                        <div class="border  p-3">
                            ...
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alt_image[{{$lang->code}}]" class="form-control" id="alt_image" placeholder="Enter Alt Image" value="{{ $des->translate($lang->code)->alt_image }}">
                        ...
                        <div class="border p-3">
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_image[{{$lang->code}}]" class="form-control" id="title_image" placeholder="Enter Title Image" value=" {{ $des->translate($lang->code)->title_image }}">
